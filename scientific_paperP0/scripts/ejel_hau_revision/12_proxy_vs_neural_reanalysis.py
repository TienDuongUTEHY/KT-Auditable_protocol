# -*- coding: utf-8 -*-
"""
Stage 8: Separates traditional proxies (LR-KT proxy) from deep neural KT backbones.
...
def main():
    print("Stage 8: Separates traditional proxies (LR-KT proxy) from deep neural KT backbones.")
