...
Write-Host "Starting Automated Pipeline Execution for Algebra 2005-2006..."
...
Write-Host "Done $Dataset pipeline reproduction!"
Write-Host "Algebra 2005-2006 Pipeline Completed Successfully."
